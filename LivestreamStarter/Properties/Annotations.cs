...
namespace LivestreamStarter.Properties
{
  /// <summary>
  ...
  /// <item>Input    ::= ParameterName: Count [, Input]*</item>
  /// <item>Output   ::= [ParameterName: Count]* {halt|stop|void|nothing|Count}</item>
  /// <item>Count    ::= true | false | null | notnull | canbenull</item>
  /// </list>
